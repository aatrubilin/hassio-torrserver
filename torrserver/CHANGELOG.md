...
- 🕶 Upgraded TorrServer to **MatriX.142.2** (changes: [MatriX.142.2](https://github.com/YouROK/TorrServer/releases/tag/MatriX.142.2))

## 2.0.1-MatriX.142.1 [2026-07-14]
...
- 🕶 Upgraded TorrServer to **MatriX.142** (changes: [MatriX.142](https://github.com/YouROK/TorrServer/releases/tag/MatriX.142))

## 2.0.0-MatriX.141 [2026-02-26]

### ✨ New features

- 🕶 Upgraded TorrServer to **MatriX.141** (changes: [MatriX.140](https://github.com/YouROK/TorrServer/releases/tag/MatriX.140) / [MatriX.141](https://github.com/YouROK/TorrServer/releases/tag/MatriX.141))
